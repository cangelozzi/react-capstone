              ...
              <form>
                <div className="col-md-6 col-md-offset-3">
                  <div className="input-group input-group-lg">
                    <input ref="artistName" type="text" className="form-control" placeholder="E.g. Pink Floyd" onChange={this.setInputFieldValue} />
                    <span className="input-group-btn">
                      <button className="btn btn-default" type="button" onClick={this.searchItems}>Search!</button>
                    </span>
                  </div>
                </div>
              </form>
